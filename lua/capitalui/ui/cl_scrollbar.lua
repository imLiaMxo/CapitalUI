...
function PANEL:Init()
    self.NormalCol = Capital.UI.Colors.Scroller
    self.HoverCol = Capital.UI.OffsetColor(self.NormalCol, 15)

    self.Colour = Capital.UI.CopyColor(self.NormalCol)
end
...
function PANEL:Paint(w, h)
    self.Colour = Capital.UI.LerpColor(FrameTime() * 12, self.Colour,
...
function PANEL:Init()
    ...
    self.BackgroundCol = Capital.UI.OffsetColor(Capital.UI.Colors.Background, 5)

    self.Scrollbar = vgui.Create("Capital.UI.ScrollbarGrip", self)
...
function PANEL:Paint(w, h)
    draw.RoundedBox(w / 2, 0, 0, w, h, self.BackgroundCol)
end

vgui.Register("Capital.UI.Scrollbar", PANEL, "Panel")